...
import com.example.androidproject.databinding.CommentSampleBinding;
...
public class CommentAdapter extends  RecyclerView.Adapter<CommentAdapter.viewHolder>{
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
       ...
       holder.binding.commentedTime.setText(text);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        Picasso.get().load(user.getProfile_image())
                                ...
                                .into(holder.binding.commentedImage);

                        holder.binding.commentedName.setText(Html.fromHtml("<b>" + user.getFirstName()+"    " + "</b>"+ " " + comment.getCommentBody()));
